...
async function loadAllEmployees() {
  const response = await fetch("http://127.0.0.1:8002/employees");
...
async function loadTodayLogs() {
  const response = await fetch("http://127.0.0.1:8002/logs");
  const teamList = document.getElementById("teamList");
  teamList.innerHTML = "";
...
async function loadOnlineEmployees() {
  const responseLogs = await fetch("http://127.0.0.1:8002/logs");
  const responseEmployees = await fetch("http://127.0.0.1:8002/employees");
